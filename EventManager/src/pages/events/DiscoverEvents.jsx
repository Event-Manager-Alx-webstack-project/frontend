...
const DiscoverEventsPage = () => {
    ...
    // Filter events, with checks to avoid errors with null or undefined values
                    ...
                    <div className="relative max-w-2xl mx-auto">
                        ...
                        <button className="absolute right-0 top-0 mt-2 mr-3 bg-black text-white p-3 rounded-full hover:bg-orange-600 transition duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-5 h-5">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m0 0a7 7 0 111 1z" />
                            </svg>
                        </button>
                    </div>
                </div>
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                            {filteredEvents.map(event => (
                                <EventCard
                                    key={event.id}
                                    title={event.name} // Ensure correct property is used
                                    date={event.date}
